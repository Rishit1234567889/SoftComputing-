# Practical 3 : Write a program to implement artificial neural network with back propogation.
import pandas as pd
...
# Load the dataset
file_path = r'/content/ADANIPORTS.csv'  # Use raw string to avoid invalid escape sequence errors
try:
